...
public BigDecimal calculaTotalMovimentacao(Conta conta, TipoMovimentacao tipo){
	String jpql = "select sum(m.valor) from Movimentacao "+
			"m where m.conta=:conta and m.tipoMovimentacao=:tipo";
...
public List<Movimentacao> buscarTodasModificacoesDaContaPorTitular(String titular){
	String jpql = "select m from Movimentacao m "+
